...
ROADMAPS = {
    ...
    "grc_engineer": {
        "title": "GRC Engineer",
        "tagline": "Govern risk and compliance: build the controls, frameworks, and audits that keep an org secure and certified.",
        "salary": "$95k - $150k (US median ~$120k)",
        "duration": "12 - 24 months",
        "demand": "High",
        "keywords": ["grc engineer", "grc analyst", "grc", "governance risk and compliance",
                     "governance risk compliance", "compliance engineer", "compliance analyst",
                     "risk and compliance", "security compliance", "it auditor", "security auditor"],
        "stages": [
            {
                "kind": "foundation",
                "phase": "Phase 1 - Security & IT foundations",
                "timeframe": "Months 1-3",
                "title": "Understand security controls & IT/cloud basics",
                "blurb": "You govern what you understand: learn how systems, data, and security controls work.",
                "items": [
                    {"name": "CompTIA Security+ knowledge base", "type": "skill",
                     "url": "https://www.comptia.org/certifications/security",
                     "detail": "The vocabulary of controls, risk, and security you'll govern."},
                    {"name": "Cloud & IT fundamentals (AWS/Azure basics)", "type": "skill",
                     "url": "https://aws.amazon.com/training/learn-about/cloud-practitioner/",
                     "detail": "Most controls today live in the cloud - know the basics."},
                ],
            },
            {
                "kind": "education",
                "phase": "Phase 2 - Frameworks & standards",
                "timeframe": "Months 2-6",
                "title": "Learn the GRC frameworks",
                "blurb": "The core of the job: the frameworks and regulations orgs are audited against.",
                "items": [
                    {"name": "NIST Cybersecurity Framework & RMF (800-53)", "type": "education",
                     "url": "https://www.nist.gov/cyberframework",
                     "detail": "The most widely used US risk/control framework."},
                    {"name": "ISO/IEC 27001 (ISMS)", "type": "education",
                     "url": "https://www.iso.org/standard/27001",
                     "detail": "The global information-security management standard."},
                    {"name": "SOC 2, PCI DSS, GDPR & HIPAA overview", "type": "skill",
                     "url": "https://www.aicpa-cima.com/topic/audit-assurance/audit-and-assurance-greater-than-soc-2",
                     "detail": "Know which regime applies to which business."},
                ],
            },
            {
                "kind": "certification",
                "phase": "Phase 3 - Entry credential",
                "timeframe": "Months 4-8",
                "title": "Security+ (baseline)",
                "blurb": "Clears resume filters and proves core security literacy for GRC roles.",
                "items": [
                    {"name": "CompTIA Security+ (SY0-701)", "type": "certification",
                     "url": "https://www.comptia.org/certifications/security",
                     "detail": "The baseline security credential; widely required."},
                    {"name": "(Optional) ISC2 Certified in Cybersecurity (CC)", "type": "certification",
                     "url": "https://www.isc2.org/certifications/cc",
                     "detail": "Free entry cert to strengthen fundamentals."},
                ],
            },
            {
                "kind": "certification",
                "phase": "Phase 4 - GRC flagship certs",
                "timeframe": "Months 8-24",
                "title": "CRISC / CISA / CGRC / ISO 27001",
                "blurb": "These are the credentials recruiters search for in GRC candidates.",
                "items": [
                    {"name": "ISACA CRISC (risk)", "type": "certification",
                     "url": "https://www.isaca.org/credentialing/crisc",
                     "detail": "The premier risk-management credential for GRC."},
                    {"name": "ISACA CISA (audit)", "type": "certification",
                     "url": "https://www.isaca.org/credentialing/cisa",
                     "detail": "The gold standard for IT audit and control assurance."},
                    {"name": "ISC2 CGRC (governance, risk & compliance)", "type": "certification",
                     "url": "https://www.isc2.org/certifications/cgrc",
                     "detail": "Formerly CAP; authorization & continuous compliance."},
                    {"name": "ISO 27001 Lead Implementer / Lead Auditor", "type": "certification",
                     "url": "https://pecb.com/en/education-and-certification-for-individuals/iso-iec-27001",
                     "detail": "Implement or audit an ISMS - highly valued for ISO shops."},
                ],
            },
            {
                "kind": "experience",
                "phase": "Phase 5 - Do real GRC work",
                "timeframe": "Months 6-24",
                "title": "Run assessments, controls & audits",
                "blurb": "Recruiters hire on demonstrated audits and control work, not theory.",
                "items": [
                    {"name": "Perform a risk assessment & control mapping", "type": "experience",
                     "url": "https://csrc.nist.gov/projects/risk-management/about-rmf",
                     "detail": "Map controls to NIST/ISO and document the gaps."},
                    {"name": "Learn a GRC / compliance-automation platform", "type": "lab",
                     "url": "https://www.vanta.com/",
                     "detail": "Vanta, Drata, ServiceNow GRC, or RSA Archer - platform skills are in demand."},
                    {"name": "Support a SOC 2 or ISO 27001 audit end-to-end", "type": "experience",
                     "url": "https://www.aicpa-cima.com/topic/audit-assurance/audit-and-assurance-greater-than-soc-2",
                     "detail": "Evidence collection, control testing, remediation."},
                ],
            },
            {
                "kind": "role",
                ...
                "timeframe": "Apply now",
                "title": "GRC Engineer",
                "blurb": "Framework fluency (NIST/ISO), a GRC cert (CRISC/CISA/CGRC), platform skills, and real audit experience.",
                "items": [],
            },
        ],
    },
    ...
    "ciso": {
        ...
        "tagline": "The executive security-leadership track: own strategy, risk, budget, and the board relationship for a whole organisation.",
        "salary": "$200k - $400k+ (US median ~$260k)",
        "duration": "10+ years (senior executive track)",
        "demand": "High",
        "keywords": ["ciso", "chief information security officer", "security executive",
                     "head of security", "vp security", "vp of security", "information security officer",
                     "security director", "director of security"],
        "stages": [
            {
                "kind": "foundation",
                "phase": "Phase 1 - Deep security & IT base",
                "timeframe": "Prerequisite",
                "title": "Master the full security domain first",
                "blurb": "CISOs are built on a decade of credibility across security and IT.",
                "items": [
                    {"name": "10-15 years across security & IT", "type": "experience",
                     "url": "https://www.cyberseek.org/pathway.html",
                     "detail": "Breadth across engineering, operations, risk, and compliance."},
                    {"name": "Master the CISSP 8 domains", "type": "skill",
                     "url": "https://www.isc2.org/certifications/cissp",
                     "detail": "The body of knowledge a security leader is expected to own."},
                ],
            },
            {
                "kind": "education",
                "phase": "Phase 2 - Business, risk & leadership",
                "timeframe": "Ongoing",
                "title": "Lead people, risk, and the business",
                "blurb": "The CISO job is 20% tech, 80% risk, budget, communication, and influence.",
                "items": [
                    {"name": "Security leadership & strategy (SANS MGT514)", "type": "education",
                     "url": "https://www.sans.org/cyber-security-courses/security-strategic-planning-policy-leadership/",
                     "detail": "Build strategy, policy, and a security program."},
                    {"name": "Enterprise risk management (NIST / ISO)", "type": "skill",
                     "url": "https://www.nist.gov/cyberframework",
                     "detail": "Quantify and communicate risk to the business."},
                    {"name": "Finance & business acumen for executives", "type": "skill",
                     "url": "https://www.coursera.org/learn/finance-for-non-finance-managers",
                     "detail": "Own a budget and speak the board's language."},
                ],
            },
            {
                "kind": "certification",
                "phase": "Phase 3 - Senior security certs",
                "timeframe": "Years 1-3",
                "title": "CISSP + CISM",
                "blurb": "The two credentials virtually every CISO posting lists.",
                "items": [
                    {"name": "CISSP - (ISC)2", "type": "certification",
                     "url": "https://www.isc2.org/certifications/cissp",
                     "detail": "The senior security gold standard."},
                    {"name": "CISM - ISACA (security management)", "type": "certification",
                     "url": "https://www.isaca.org/credentialing/cism",
                     "detail": "Management-focused; core for security leadership."},
                ],
            },
            {
                "kind": "certification",
                "phase": "Phase 4 - Executive credential",
                "timeframe": "Years 3-6",
                "title": "CCISO (and governance certs)",
                "blurb": "Executive-level credentials that signal board-ready leadership.",
                "items": [
                    {"name": "EC-Council CCISO (Certified CISO)", "type": "certification",
                     "url": "https://www.eccouncil.org/train-certify/certified-chief-information-security-officer-ciso/",
                     "detail": "Purpose-built executive CISO certification."},
                    {"name": "ISACA CGEIT / CRISC (governance & risk)", "type": "certification",
                     "url": "https://www.isaca.org/credentialing/cgeit",
                     "detail": "Governance of enterprise IT and risk leadership."},
                ],
            },
            {
                "kind": "experience",
                "phase": "Phase 5 - Run the security program",
                "timeframe": "Ongoing",
                "title": "Lead a program, a team, and the board",
                "blurb": "You are hired on outcomes: reduced risk, passed audits, and executive trust.",
                "items": [
                    {"name": "Build & run a security program (team + budget)", "type": "experience",
                     "url": "https://www.sans.org/cyber-security-courses/security-strategic-planning-policy-leadership/",
                     "detail": "Own strategy, hiring, and spend across the function."},
                    {"name": "Lead incident response & report to the board", "type": "experience",
                     "url": "https://www.nist.gov/cyberframework",
                     "detail": "Communicate risk and incidents to executives and the board."},
                ],
            },
            {
                "kind": "role",
                ...
                "timeframe": "Apply now",
                "title": "CISO (Chief Information Security Officer)",
                "blurb": "Deep security base, CISSP + CISM + CCISO, and a track record leading programs, budgets, and the board.",
                "items": [],
            },
        ],
    },
